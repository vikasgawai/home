...
Yet, it remains unclear how a comparable technology (high-speed internet broadband) affects a more vulnerable older population. This paper examines the effect of high-speed internet broadband on the mental health of older adults (aged 50+) in the United States. Leveraging the quasi-experimental staggered rollout of high-speed internet broadband, combined with individual panel data, I utilize spatial, temporal, and individual-level variations in broadband availability and employ advanced difference-in-differences (DID) estimators.
I find that the introduction of high-speed broadband significantly improves mental health among older adults (decline in depression symptoms by 5.2\%), comparable with other major life events like job loss, recession, and the death of a spouse. I find evidence of novel mechanisms like an increase in \textit{social connectedness} and a decline in \textit{social isolation}.
...
Heterogeneous effects by race and gender highlight barriers for African Americans and women, while rural older adults benefit more from broadband, suggesting potential benefits for rural areas.
