...
-Discrimination in Science: Salaries of Foreign and US Born Land-Grant University Scientists  \textit{with Jeremy Foltz} \textbf{(under review)}\\ \\
...
-Diversity Academy Fellow, School of Public Affairs, American University \hfill \textit{2023} \\
-Junior Fellow, Retirement and Disability Research Center (\textbf{RDRC}) Center for Financial Security (CFS), Social Security Administration (\textbf{SSA}) 
 \hfill \textit{2022} 
...
\begin{rSection}{Grants, Research Funding}
