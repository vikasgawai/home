...
Spillover Effect of a Bicycle Policy on Girls' Enrollment in Middle Schools
...
-Effect of Early Life Exposure to Agriculture Shock on Later Life Cognitive Health of Older Adults \textit{with Valentina Duque, Jinkook, Lee, Lauren Schmitz} (\textit{presented at APPAM}) \\
-Effect of Early Life Exposure to Agriculture Shock on next generation's Human Capital \textit{with Valentina Duque, Lauren Schmitz} (\textit{presented at PAA})
...
%\textit{Referee For:} Land Economics \\ 
%\textit{Department Service:} 
Economics of Education Review, \textit{Reviewer} {\hfill\textit{2022-}} \\ 
...
Research Assistant to Prof. Lauren Schmitz (UW Madison, School of Public Affairs) and Prof. Valentina Duque (University of Sydney, Princeton University, American University) \hfill \textit{2020--} \\
Research Assistant to Prof. Jeremy Foltz and Prof. Bradford Barham (UW Madison, AAE) \hfill \textit{2018-2020} \\
Research Assistant to Prof. Andra Ghent (UW Madison, Wisconsin School of Business, ) \hfill \textit{May-Sept (2018)}
\end{rSection}
