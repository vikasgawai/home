...
\address{1445, Druid Valley Dr NE, Atlanta, 30329, GA, USA} % Your address
%\address{123 Pleasant Lane \\ City, State 12345} % Your secondary addess (optional)
\address{Phone: 608-628-8674 \\ Email: \email{vikas.vjti87@gmail.com} \\ \href{https://vikasgawai.github.io/home/}{Website} \\ \href{https://scholar.google.com/citations?user=bGRBndAAAAAJ&hl=en&oi=ao}{Google Scholar}}
...
{\bf Prevention Effectiveness (PE) Fellow}, Centers for Disease Control and Prevention (CDC) \hfill {\em 2024-} 
...
\item Is there a link between access to broadband and health outcomes?. \textit{with Steven Deller \textbf{American Journal of Economics and Sociology (2024)}}
...
\item Does Broadband Technology Affect Social Security Applications? \textit{\scriptsize{(Award from Retirement and Disability Research Center (\textbf{RDRC}) Center for Financial Security (CFS), Social Security Administration (\textbf{SSA}))}} \href{https://cfsrdrcwiscedu.podbean.com/e/episode-8-interview-with-dr-vikas-gawai-broadband-technologys-impact-on-social-security-applications}{-Podcast interview}
...
\begin{rSection}{CDC Research Work in Progress}
\begin{itemize}

\item Effect of Preventive Health and Health Services (PHHS) Block Grant on the Performance of the State Public Health Departments, with \textit{Sergey Sotnikov and Nancy Habarta} (\textit{\scriptsize{abstract submitted at AcademyHealth '25}})

\item Systematic Review of the Literature on the Effects of Public Infrastructure Investments and Health Outcomes, with \textit{Sergey Sotnikov and Nancy Habarta}
...
\begin{rSection}{Media Highlight}
-Internent and Mental Health \href{https://grow.cals.wisc.edu/departments/features/the-road-to-rural-broadband}{GROW MAGAZINE cover story} \\
-Broadband and Social Security Applications  \href{https://cfsrdrcwiscedu.podbean.com/e/episode-8-interview-with-dr-vikas-gawai-broadband-technologys-impact-on-social-security-applications}{-Podcast interview}
\end{rSection}
...
\begin{rSection}{Conference Presentations} 
	...
	Association for Public Policy Analysis \& Management (APPAM) {\hfill \em 2022, 23, 24} \\
...
CDC Preventive Effectiveness Fellowship Hiring Committee  {\hfill\textit{2025}}\\ 
...
%\textit{Referee For:} Land Economics \\ 
%\textit{Department Service:} 
Agriculture and Applied Economics Association (AAEA), \textit{Abstract Reviewer} {\hfill \textit{2022, 2023, 2024}}\\
...
\begin{rSection}{Research Assistant}
%{\bf Ideas42}	\\
%Consultant {\hfill \em 2021--}
\textbf{Research Assistant} to Prof. Lauren Schmitz (UW Madison, School of Public Affairs) and Prof. Valentina Duque (American University) \hfill \textit{2020--} \\
...
%{\bf Ideas42}	\\
%Consultant {\hfill \em 2021--}
Guest Lecturer: \textbf{World Hunger and Malnutrition}, (Instructor- Prof. Jeremy Foltz) UW-Madison
 \hfill \textit{Spring 2024} \\
Guest Lecturer: \textbf{Agricultural \& Economic Development of Africa (Health)}, (Instructor- Osaretin Olurotimi) UW-Madison
 \hfill \textit{Spring 2022} \\
Guest Lecturer: \textbf{International Studies (Gender Gap and Economics Development in Developing Countries)}, (Instructor- Prof. Jeremy Foltz) UW-Madison
 \hfill \textit{Spring 2022, 2023} \\
Guest Lecturer: \textbf{The Economics of Race and Gender} (Gender Gap in Developing Countries), (Instructor- Prof. Meghan I. Esson) Bentley University
 \hfill \textit{Spring 2022}
\end{rSection}
