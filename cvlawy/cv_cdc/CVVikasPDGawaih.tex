...
\begin{rSection}{Research Interests}
Health, Aging, Social Security, Public Policy, Race, Gender, Technology
\end{rSection}
...
\item Discrimination in Science: Salaries of Foreign and US Born Land-Grant University Scientists  \textit{with Jeremy Foltz}
 \textbf{(Revise and Resubmit at \textit{American Journal of Agricultural Economics})} \textit{\scriptsize{(Presentation - AAEA (August '22))}}
...
\item Early-Life Economic Conditions and Old-Age Mortality: Evidence from Historical County-Level Bank Deposit Data, \textit{with Valentina Duque, Jason Fletcher, Hamid Noghanibehambari, Lauren Schmitz}-  \textbf{(Revise and Resubmit at \textit{Journal of Population Economics})}
\iffalse \textbf{Abstract-}
...
\item The effect of Broadband Technology on Social Security Insurance Enrollment among Older Adults \textit{\scriptsize{(Competitive award from Retirement and Disability Research Center (\textbf{RDRC}) Center for Financial Security (CFS), Social Security Administration (\textbf{SSA}))}}
